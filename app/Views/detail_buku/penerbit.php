...
<?= $this->section('script') ?>
    <script>
        ...
        $('#table-users').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?= base_url('admin/detail-buku/penerbit/json') ?>',
            stateSave: true,    
            ...
            buttons: [
                {
                    ...
                    action: function (e, dt, node, config) {
                        window.location.href = '<?= base_url('admin/detail-buku/penerbit/create') ?>';
                    }
                }
            ],
            ...
            columns: [
                ...
                { data: 'email' },
                {
                    ...
                    render: function (data, type, row) {
                        if (type === 'display') {
                            var urlEdit  = '<?= base_url('admin/detail-buku/penerbit/edit') ?>/' + data;
                            var urlHapus = '<?= base_url('admin/detail-buku/penerbit/delete') ?>/' + data;
